class DailyMailReportWorker
	...
	def perform
		...
		msj1_txt = ""
		msj1_html = ac.render_to_string partial: '/shared/mail/news', :locals => {:@title => title1}, :object => @cases, layout: false
		Case.send_email(
			title1,
			destinatarios,
			msj1_txt,
		...
		msj2_html = ac.render_to_string partial: '/shared/mail/developments', :locals => {:@title => title2}, :object => @elements, layout: false
		Case.send_email(
			title2,
			destinatarios,
			msj1_txt,
